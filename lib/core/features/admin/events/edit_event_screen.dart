...
// Formulario para editar un evento existente del calendario.
// ═══════════════════════════════════════════════════════════════
...
class _EditEventScreenState extends ConsumerState<EditEventScreen> {
  ...
  Future<void> _pickDate({bool isEnd = false}) async {
    ...
    final first = isEnd ? _date : DateTime(2020);
    ...
    setState(() {
      ...
      if (isEnd) {
        ...
        _date = dt;
        _isAllDay = !useTime;
        if (useTime && _reminderMinutesBefore == 0) {
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _reminderChip(1440, '1 dÃ­a antes', isDark),
                      ],
                    ),
                  ],
                ),
