...
// Panel analítico animado del rendimiento de Yordan.
// ═══════════════════════════════════════════════════════════════
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  _entry(4, _BarChartCard(
                    title: 'Tendencia mensual',
                    subtitle: 'Completadas por semana',
                    data: stats.last4Weeks,
                    max: stats.max4Weeks,
                    labelBuilder: (d) => 'S${stats.last4Weeks.indexOf(d) + 1}',
                    isDark: isDark,
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: CircularProgressIndicator(
                            value: value,
                            strokeWidth: 8,
                            backgroundColor: (isDark ? Colors.white : AppColors.lightGrey)
...
class _LegendRow extends StatelessWidget {
  ...
  const _LegendRow({
    ...
    required this.value, required this.pct, required this.isDark,
  });
...
class _TrendStat extends StatelessWidget {
  ...
  const _TrendStat({
    ...
    required this.sub, required this.isDark, required this.color,
  });
